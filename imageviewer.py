...
my_img6 = ImageTk.PhotoImage(Image.open("images/img6.png"))
my_img7 = ImageTk.PhotoImage(Image.open("images/img7.png"))
my_img8 = ImageTk.PhotoImage(Image.open("images/img8.png"))
my_img9 = ImageTk.PhotoImage(Image.open("images/img9.png"))
my_img10 = ImageTk.PhotoImage(Image.open("images/img10.png"))
